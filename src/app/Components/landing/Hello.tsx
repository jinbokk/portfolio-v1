    ...
    <>
      <section className="relative mb-60 flex justify-center">
        ...
        <div className="relative bottom-14 up-1 opacity-0">
          <div className="lg:text-2xl md:text-xl text-xl relative left-3 text-highlight">
            Hello, my name is
          </div>
          <div className="lg:text-10xl md:text-8xl text-7xl font-bold mb-6">
            JINBOK LEE
          </div>
          <div className="lg:text-2xl md:text-xl text-xl relative left-3 text-highlight">
            And i am
          </div>
          <div className="lg:text-10xl md:text-8xl text-7xl font-bold">
            SOFTWARE
          </div>
          <div className="lg:text-10xl md:text-8xl text-7xl font-bold">
            ENGINEER
