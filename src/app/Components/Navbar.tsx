      ...
      {windowWidth < 1024 ? (
        <nav className="fixed z-50 w-full">
          <div className="flex justify-between items-center backdrop-blur-sm border-b border-highlight">
            ...
            //* navLogo
              */}
            <Link href="/" className="relative group z-50 w-12 h-12 my-3 mx-5">
              <svg
                version="1.1"
        ...
        <nav className="hidden md:block">
          ...
          //* navButtons
            */}
          <div className="buttonContainer fixed z-50 bottom-0 right-[80px] flex items-center [writing-mode:vertical-lr] opacity-70">
            <a
              href="https://github.com/jinbokk"
              target="_blank"
              className="group"
